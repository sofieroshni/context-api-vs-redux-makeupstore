            ...
            <div className="detail ms-4">
                ...
                <div className='buttons'>
                    <button className='rounded'>{product.quantity}</button>
                                <button className='rounded-cicle px-2 bg-light border-0px' onClick={() => dispatch({type: "Decrease", id: product.id})}>-</button>

                        <button className='rounded-cicle px-2' onClick={() => dispatch({type: "Increase", id: product.id})}>+</button>
                </div>
